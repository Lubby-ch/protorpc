...
func init() {
	proto.RegisterType((*RequestHeader)(nil), "plugin.wire.RequestHeader")
	proto.RegisterType((*ResponseHeader)(nil), "plugin.wire.ResponseHeader")
	proto.RegisterEnum("plugin.wire.Const", Const_name, Const_value)
}
